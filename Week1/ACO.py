...
# Puedes ajustar estas coordenadas para que las ciudades se vean mejor en el grafo
CITY_POSITIONS = {
    "C1": (2, 1),
    "C2": (0, 3),
    "C3": (3, 2),
...
COSTS_MATRIX = np.array([
    # C1    C2     C3     C4      C5      C6      C7      C8    C9      C10
    [0,     120,   80,    np.inf, np.inf, np.inf, np.inf, 50,    60,    np.inf], # C1
    [120,   0,     90,    70,     np.inf, 60, np.inf, np.inf,np.inf, 40],     # C2
    [80,    90,    0,     np.inf, np.inf, np.inf, np.inf, np.inf,30,    50],     # C3
    [np.inf,70,    np.inf,0,      60,     20,     58, np.inf,np.inf, np.inf], # C4
    [np.inf,np.inf,np.inf,60,     0,      30,     np.inf, np.inf,np.inf, 70], # C5
    [np.inf,42,np.inf,20,     30,     0,      50, np.inf,30, np.inf], # C6
    [np.inf,np.inf,np.inf,50, np.inf, np.inf, 0,      np.inf,np.inf, np.inf], # C7
